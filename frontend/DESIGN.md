---
LƯU Ý: Hãy áp dụng toàn bộ tỷ lệ, khoảng cách, font chữ, viền border, và phong cách dark mode của hệ thống thiết kế này. Tuy nhiên, thay vì dùng màu Trắng/Đen làm màu nhấn (accent color), hãy sử dụng màu Xanh/Tím đặc trưng của thương hiệu Almotion cho các nút bấm (buttons) và các trạng thái active.
version: alpha
